...
class KangarooDataset(mrcnn.utils.Dataset):
    ...
    def load_dataset(self, dataset_dir, is_train=True):
        ...
        self.add_class("dataset", 1, "plant-disease")

        images_dir = os.path.join(os.path.abspath('.'), dataset_dir, 'images')
        annotations_dir = os.path.join(os.path.abspath('.'), dataset_dir, 'annots')
    ...
    def load_mask(self, image_id):
        ...
        for i in range(len(boxes)):
            ...
            class_ids.append(self.class_names.index('plant-disease'))
